import { ArrowLeft, CreditCard, Headphones, ShieldCheck, ShoppingBag, Sparkles, Truck } from "lucide-react";
...
function FeatureRow({ title, description, icon, delay = "0ms" }: FeatureRowProps) {
  return (
    <div
              ...
              {trustItems.map((item) => (
                ...
                >
                  <div
                    ...
                    style={{ animation: "trust-pulse 4.2s ease-in-out infinite" }}
                  >
                    {item.value}
                  </div>
